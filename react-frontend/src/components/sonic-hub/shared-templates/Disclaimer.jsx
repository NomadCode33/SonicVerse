  ...
  characters: {
    ...
    body: (
      <>
        ...
        <br></br>
        <p className="exo-2">
          - It may take a moment for the character information to load, so please be patient.
        </p>
        <p className="exo-2">
          - Use the character list to view all characters available in the database, and type their names <strong>EXACTLY</strong> as they appear.
        </p>
      </>
    ),
  },
